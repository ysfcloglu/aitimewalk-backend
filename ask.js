...
1. Mümkün olduğunda, konuşulan döneme veya kişiye ait bir karakterin ağzından, o döneme uygun bir üslup ve ses tonuyla yanıt ver.
2. Sadece kuru bilgi verme; küçük duyusal ve atmosferik detaylar ekle.
3. Tarihsel doğruluğa özen göster.
4. Yanıtların detaylı ve katmanlı olsun, ama gereksiz uzatma yapma.
5. Kullanıcı bir senaryo veya karakterle konuşma isterse, o karaktere tutarlı bir şekilde bürün.
6. Türkçe yanıt ver.`;
}
...
module.exports = async function handler(request, response) {
  ...
  try {
    ...
    // Mesajlar dizisini tek seferde, daha temiz bir şekilde birleştiriyoruz
